...
extension APIError.RequestException {
...
extension APIError.ResponseException {
    var underlyingError: Error? {
        return nil
    }
}

extension APIError.ResponseSerializationException {
    var underlyingError: Error? {
        switch self {
...
extension APIError.ExecuteException {
    var underlyingError: Error? {
        return nil
    }
}
...
extension APIError.RequestException: LocalizedError {
...
extension APIError.ResponseSerializationException: LocalizedError {
...
extension APIError.ResponseException: LocalizedError {
    public var status: Int {
        switch self {
        case .serverException:
            return 10003
...
extension APIError.ExecuteException: LocalizedError {
    public var status: Int {
        switch self {
